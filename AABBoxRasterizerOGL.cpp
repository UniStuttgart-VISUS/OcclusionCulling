...
#include "AABBoxRasterizerOGL.h"

AABBoxRasterizerOGL::AABBoxRasterizerOGL()
	: mNumModels(0),
...
//--------------------------------------------------------------------
void AABBoxRasterizerOGL::CreateTransformedAABBoxes(CPUTAssetSet **pAssetSet, UINT numAssetSets)
{
	...
	mpTransformedAABBox = new TransformedAABBoxOGL[mNumModels];
...
void AABBoxRasterizerOGL::SetViewProjMatrix(float4x4 *viewMatrix, float4x4 *projMatrix, UINT idx)
{
...
//-------------------------------------------------------------------------
void AABBoxRasterizerOGL::RenderVisible(CPUTAssetSet **pAssetSet,
...
// models that are marked as visible by the software occlusion culling test
//-------------------------------------------------------------------------
void AABBoxRasterizerOGL::Render(CPUTAssetSet **pAssetSet,
	CPUTRenderParametersDX &renderParams,
	UINT numAssetSets,
	UINT idx)
{
