...
extern bool gEnableCullingDX11;
extern bool gEnableFCullingDX11;
extern bool gViewDepthBufferDX11;
extern bool gViewBoundingBoxDX11;
extern bool gEnableTasksDX11;
extern bool gPipelineDX11;
extern float gCameraDX11[6];
extern float gOccluderSizeThresholdDX11;
extern float gOccludeeSizeThresholdDX11;
extern UINT  gDepthTestTasksDX11;
extern UINT gCameraTourDX11;
extern UINT gFramesForEvaluationDX11;
...
#elif defined(DP_TEST)
	const int SCREENW = 80;
	const int SCREENH = 48;

	const int TILE_WIDTH_IN_PIXELS = 16;
	const int TILE_HEIGHT_IN_PIXELS = 24;
#endif
