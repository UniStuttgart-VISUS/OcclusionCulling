...
#ifndef AABBOXRASTERIZEROGL_H
#define AABBOXRASTERIZEROGL_H

#include "AABBoxRasterizer.h"
#include "TransformedAABBoxOGL.h"

class AABBoxRasterizerOGL : public AABBoxRasterizer
{
public:
	AABBoxRasterizerOGL();
	virtual ~AABBoxRasterizerOGL();
...
protected:
	UINT mNumModels;
	TransformedAABBoxOGL *mpTransformedAABBox;
