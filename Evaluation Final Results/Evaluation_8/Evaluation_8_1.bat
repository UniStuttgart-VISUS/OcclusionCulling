...
SET depthTestTasks=5                    &:: default: 20         Values: [1 - 50]
...
SET occluderSizeThreshold=1.5           &:: default: 1.5        Values: [0.0 - 5.0]
SET occludeeSizeThreshold=0.01          &:: default: 0.01       Values: [0.0 - 0.1]
SET depthTestTasks=100                  &:: default: 20         Values: [1 - 50]
SET cameraTour=1                        &:: default: 0          Values: [1]
SET framesForEvaluation=100             &:: default: 0          Values: [int]
SET DBResolution=3                      &:: default: 3          Values: [0-4]
...
SET evaluation=OGL_0 OGL_1 OGL_2 "OGL 5 Tasks" "OGL 20 DT Tasks" "OGL 100 DT Tasks"
...
SET evaluation=SSE_0 SSE_1 SSE_2 "SSE 5 Tasks" "SSE 20 DT Tasks" "SSE 100 DT Tasks"
