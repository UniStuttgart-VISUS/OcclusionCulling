...
SET evaluationName=Evaluation_1_SCALAR
...
SET evaluationName=Evaluation_1_SSE
...
SET evaluationName=Evaluation_1_AVX
...
SET evaluationName=Evaluation_1_MASK_AVX
...
SET evaluationName=Evaluation_1_OGL
