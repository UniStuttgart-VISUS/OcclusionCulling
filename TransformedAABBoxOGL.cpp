...
#include "TransformedAABBoxOGL.h"
...
//--------------------------------------------------------------------------
void TransformedAABBoxOGL::CreateAABBVertexIndexList(CPUTModelDX11 *pModel)
{
...
//----------------------------------------------------------------
bool TransformedAABBoxOGL::IsInsideViewFrustum(CPUTCamera *pCamera)
{
...
//----------------------------------------------------------------------------
bool TransformedAABBoxOGL::IsTooSmall(const BoxTestSetupScalar &setup, float4x4 &cumulativeMatrix)
{
...
//-----------------------------------------------------------------------------------------
bool TransformedAABBoxOGL::RasterizeAndDepthTestAABBox(UINT *pRenderTargetPixels, const float4 pXformedPos[], UINT idx)
{
