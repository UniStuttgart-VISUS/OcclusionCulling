...
// under the License.
////////////////////////////////////////////////////////////////////////////////
#ifndef DEPTHBUFFERRASTERIZEROGL_H
#define DEPTHBUFFERRASTERIZEROGL_H

#include "DepthBufferRasterizer.h"
#include "TransformedModelOGL.h"
#include "HelperScalar.h"

class DepthBufferRasterizerOGL : public DepthBufferRasterizer, public HelperScalar
{
public:
	DepthBufferRasterizerOGL();
	virtual ~DepthBufferRasterizerOGL();
...
protected:
	TransformedModelOGL* mpTransformedModels1;
	UINT mNumModels1;
...
#endif  //DEPTHBUFFERRASTERIZEROGL_H