...
DepthBufferRasterizerOGL::DepthBufferRasterizerOGL()
...
//--------------------------------------------------------------------
void DepthBufferRasterizerOGL::CreateTransformedModels(CPUTAssetSet **mpAssetSet, UINT numAssetSets)
{
	...
	mpTransformedModels1 = new TransformedModelOGL[mNumModels1];
...
//--------------------------------------------------------------------
void DepthBufferRasterizerOGL::ClearDepthTile(int startX, int startY, int endX, int endY, UINT idx)
{
...
void DepthBufferRasterizerOGL::SetViewProj(float4x4 *viewMatrix, float4x4 *projMatrix, UINT idx)
{
